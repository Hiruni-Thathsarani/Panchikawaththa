...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  List<ChartData> getChartData() {
    return [
      ...
      if (northern > 0) ChartData('Northern', northern, Color.fromARGB(255, 159, 30, 233)),
      if (central > 0) ChartData('Central', central, Color.fromARGB(255, 30, 233, 101)),
      if (uva > 0) ChartData('Uva', uva, Color.fromARGB(255, 50, 30, 233)),
      if (northWestern > 0) ChartData('North Western', northWestern, Color.fromARGB(255, 233, 30, 125)),
  ...
  List<DataEntry> getDataEntries() {
    return [
      ...
      if (northern > 0) DataEntry(northern, 'Northern', Color.fromARGB(255, 159, 30, 233)),
      if (central > 0) DataEntry(central, 'Central', Color.fromARGB(255, 30, 233, 101)),
      if (uva > 0) DataEntry(uva, 'Uva', Color.fromARGB(255, 50, 30, 233)),
      if (northWestern > 0) DataEntry(northWestern, 'North Western', Color.fromARGB(255, 233, 30, 125)),
